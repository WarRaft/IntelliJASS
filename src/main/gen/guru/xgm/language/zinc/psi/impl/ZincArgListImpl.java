...
public class ZincArgListImpl extends ASTWrapperPsiElement implements ZincArgList {

  public ZincArgListImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<ZincArg> getArgList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, ZincArg.class);
  }
