...
public class ZincExprStmtImpl extends ASTWrapperPsiElement implements ZincExprStmt {

  public ZincExprStmtImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public ZincExpr getExpr() {
    return findNotNullChildByClass(ZincExpr.class);
  }
