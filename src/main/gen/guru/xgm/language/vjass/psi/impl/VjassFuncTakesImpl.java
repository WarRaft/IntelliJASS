...
public class VjassFuncTakesImpl extends ASTWrapperPsiElement implements VjassFuncTakes {

  public VjassFuncTakesImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public VjassTypedVarList getTypedVarList() {
    return findChildByClass(VjassTypedVarList.class);
  }
