...
public class VjassStructNameImpl extends ASTWrapperPsiElement implements VjassStructName {

  public VjassStructNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VjassVisitor visitor) {
    visitor.visitStructName(this);
  }
