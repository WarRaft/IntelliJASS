...
public class VjassImplementDefImpl extends ASTWrapperPsiElement implements VjassImplementDef {

  public VjassImplementDefImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VjassVisitor visitor) {
    visitor.visitImplementDef(this);
  }
