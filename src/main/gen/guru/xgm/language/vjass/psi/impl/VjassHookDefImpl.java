...
public class VjassHookDefImpl extends ASTWrapperPsiElement implements VjassHookDef {

  public VjassHookDefImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VjassVisitor visitor) {
    visitor.visitHookDef(this);
  }
