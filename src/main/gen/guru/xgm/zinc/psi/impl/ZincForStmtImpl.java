...
public class ZincForStmtImpl extends ASTWrapperPsiElement implements ZincForStmt {

  public ZincForStmtImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public ZincForHead getForHead() {
    return findChildByClass(ZincForHead.class);
  }
