...
public class ZincVisibilityDefImpl extends ASTWrapperPsiElement implements ZincVisibilityDef {

  public ZincVisibilityDefImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ZincVisitor visitor) {
    visitor.visitVisibilityDef(this);
  }
