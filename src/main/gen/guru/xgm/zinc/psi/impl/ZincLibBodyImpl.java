...
public class ZincLibBodyImpl extends ASTWrapperPsiElement implements ZincLibBody {
  ...
  @Override
  @NotNull
  public List<ZincFuncDecl> getFuncDeclList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, ZincFuncDecl.class);
  }

  @Override
  @NotNull
  public List<ZincGvarDecl> getGvarDeclList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, ZincGvarDecl.class);
  }
