...
public class ZincLvarBodyImpl extends ASTWrapperPsiElement implements ZincLvarBody {

  public ZincLvarBodyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ZincVisitor visitor) {
    visitor.visitLvarBody(this);
  }
