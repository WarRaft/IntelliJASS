...
public class AngelScriptConstructcallImpl extends ASTWrapperPsiElement implements AngelScriptConstructcall {

  public AngelScriptConstructcallImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AngelScriptVisitor visitor) {
    visitor.visitConstructcall(this);
  }
