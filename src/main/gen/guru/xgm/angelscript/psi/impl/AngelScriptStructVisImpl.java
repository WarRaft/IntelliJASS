...
public class AngelScriptStructVisImpl extends ASTWrapperPsiElement implements AngelScriptStructVis {

  public AngelScriptStructVisImpl(@NotNull ASTNode node) {
    super(node);
  }
