...
public class AngelScriptVaraccessImpl extends ASTWrapperPsiElement implements AngelScriptVaraccess {

  public AngelScriptVaraccessImpl(@NotNull ASTNode node) {
    super(node);
  }
