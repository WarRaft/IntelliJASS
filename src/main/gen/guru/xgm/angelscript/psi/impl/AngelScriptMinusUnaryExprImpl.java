...
public class AngelScriptMinusUnaryExprImpl extends AngelScriptExprImpl implements AngelScriptMinusUnaryExpr {

  public AngelScriptMinusUnaryExprImpl(@NotNull ASTNode node) {
    super(node);
  }
