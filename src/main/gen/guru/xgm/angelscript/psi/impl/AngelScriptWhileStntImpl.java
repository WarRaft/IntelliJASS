...
public class AngelScriptWhileStntImpl extends ASTWrapperPsiElement implements AngelScriptWhileStnt {

  public AngelScriptWhileStntImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AngelScriptVisitor visitor) {
    visitor.visitWhileStnt(this);
  }
