...
public class AngelScriptFuncReturnsImpl extends ASTWrapperPsiElement implements AngelScriptFuncReturns {

  public AngelScriptFuncReturnsImpl(@NotNull ASTNode node) {
    super(node);
  }
