...
public class AngelScriptIdentifierImpl extends ASTWrapperPsiElement implements AngelScriptIdentifier {

  public AngelScriptIdentifierImpl(@NotNull ASTNode node) {
    super(node);
  }
