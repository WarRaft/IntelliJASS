...
public class AngelScriptPlusUnaryExprImpl extends AngelScriptExprImpl implements AngelScriptPlusUnaryExpr {

  public AngelScriptPlusUnaryExprImpl(@NotNull ASTNode node) {
    super(node);
  }
