...
public class AngelScriptStructDefImpl extends ASTWrapperPsiElement implements AngelScriptStructDef {

  public AngelScriptStructDefImpl(@NotNull ASTNode node) {
    super(node);
  }
