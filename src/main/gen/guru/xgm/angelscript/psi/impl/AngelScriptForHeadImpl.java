...
public class AngelScriptForHeadImpl extends ASTWrapperPsiElement implements AngelScriptForHead {

  public AngelScriptForHeadImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<AngelScriptForOp> getForOpList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, AngelScriptForOp.class);
  }
