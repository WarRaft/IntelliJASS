...
public class VjassCallStmtImpl extends ASTWrapperPsiElement implements VjassCallStmt {

  public VjassCallStmtImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public VjassFuncCall getFuncCall() {
    return findNotNullChildByClass(VjassFuncCall.class);
  }
