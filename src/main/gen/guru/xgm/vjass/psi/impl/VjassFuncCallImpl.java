...
public class VjassFuncCallImpl extends ASTWrapperPsiElement implements VjassFuncCall {

  public VjassFuncCallImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public VjassArgList getArgList() {
    return findChildByClass(VjassArgList.class);
  }

  @Override
  @NotNull
  public VjassFuncCallName getFuncCallName() {
    return findNotNullChildByClass(VjassFuncCallName.class);
  }
