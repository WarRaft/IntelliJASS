...
public class JASSNotEqualsExprImpl extends JASSExpressionImpl implements JASSNotEqualsExpr {

  public JASSNotEqualsExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JASSVisitor visitor) {
    visitor.visitNotEqualsExpr(this);
  }
