...
public class JassLtEqExprImpl extends JassExprImpl implements JassLtEqExpr {

  public JassLtEqExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public PsiElement getLtEq() {
    return notNullChild(findChildByType(LT_EQ));
  }
