...
public class JassGtEqExprImpl extends JassExprImpl implements JassGtEqExpr {

  public JassGtEqExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull JassVisitor visitor) {
    visitor.visitGtEqExpr(this);
  }
  ...
  public PsiElement getGtEq() {
    return notNullChild(findChildByType(GT_EQ));
  }
