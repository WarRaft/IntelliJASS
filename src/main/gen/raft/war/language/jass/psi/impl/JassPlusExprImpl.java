...
public class JassPlusExprImpl extends JassExprImpl implements JassPlusExpr {

  public JassPlusExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public PsiElement getPlus() {
    return notNullChild(findChildByType(PLUS));
  }
