...
public class VjassParenExprImpl extends VjassExprImpl implements VjassParenExpr {

  public VjassParenExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public VjassExpr getExpr() {
    return findNotNullChildByClass(VjassExpr.class);
  }
