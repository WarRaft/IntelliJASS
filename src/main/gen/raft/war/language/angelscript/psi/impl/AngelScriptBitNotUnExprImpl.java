...
public class AngelScriptBitNotUnExprImpl extends AngelScriptExprImpl implements AngelScriptBitNotUnExpr {

  public AngelScriptBitNotUnExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull AngelScriptVisitor visitor) {
    visitor.visitBitNotUnExpr(this);
  }
