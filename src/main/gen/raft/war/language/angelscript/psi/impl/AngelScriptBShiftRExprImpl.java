...
public class AngelScriptBShiftRExprImpl extends AngelScriptExprImpl implements AngelScriptBShiftRExpr {

  public AngelScriptBShiftRExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull AngelScriptVisitor visitor) {
    visitor.visitBShiftRExpr(this);
  }
  ...
  public PsiElement getGtGt() {
    return findNotNullChildByType(GT_GT);
  }
