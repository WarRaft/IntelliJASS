...
public class AngelScriptMinusUnExprImpl extends AngelScriptExprImpl implements AngelScriptMinusUnExpr {

  public AngelScriptMinusUnExprImpl(@NotNull ASTNode node) {
    super(node);
  }
