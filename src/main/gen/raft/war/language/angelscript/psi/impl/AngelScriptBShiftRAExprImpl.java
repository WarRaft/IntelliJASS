...
public class AngelScriptBShiftRAExprImpl extends AngelScriptExprImpl implements AngelScriptBShiftRAExpr {

  public AngelScriptBShiftRAExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull AngelScriptVisitor visitor) {
    visitor.visitBShiftRAExpr(this);
  }
