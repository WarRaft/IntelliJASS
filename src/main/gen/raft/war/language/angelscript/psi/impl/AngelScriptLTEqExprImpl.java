...
public class AngelScriptLTEqExprImpl extends AngelScriptExprImpl implements AngelScriptLTEqExpr {

  public AngelScriptLTEqExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public PsiElement getLtEq() {
    return findNotNullChildByType(LT_EQ);
  }
