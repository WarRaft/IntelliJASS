...
public class ZincFuncReturnsImpl extends ASTWrapperPsiElement implements ZincFuncReturns {

  public ZincFuncReturnsImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public ZincTypeName getTypeName() {
    return findChildByClass(ZincTypeName.class);
  }
