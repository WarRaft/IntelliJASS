...
public class BlpReader extends ImageReader {
     ...
     *
     * @throws IOException - is header cannot be loaded
     */
     ...
     * @throws IndexOutOfBoundsException if the image does not exist.
     */
        ...
        if (intSrc != null) {
            try {
                ...
                processWarningOccurred(
                        BlpBundle.message("ISCloseFail", e.getMessage())
                );
            }
            intSrc = null;
        }
     ...
     */
    protected void processWarningOccurred(String msg) {
