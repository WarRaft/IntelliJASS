...
final class JassFormattingModelBuilder implements FormattingModelBuilder {
    ...
    private static SpacingBuilder createSpaceBuilder(CodeStyleSettings settings) {
        return new SpacingBuilder(settings, JassLanguage.INSTANCE)
                .around(JassTypes.SEPARATOR)
                .spaceIf(settings.getCommonSettings(JassLanguage.INSTANCE.getID()).SPACE_AROUND_ASSIGNMENT_OPERATORS)
