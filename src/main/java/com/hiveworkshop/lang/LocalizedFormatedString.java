...
public class LocalizedFormatedString {
     ...
     * string.
     *
     * @param baseName name of ResourceBundle to be used.
     * @param keyword  name of specific string resource to use.
     * @param args     arguments used to format string resource.
     * @throws IllegalArgumentException if baseName or keyword are null.
     */
     ...
     *
     * @param locale the locale the returned String will target.
