package guru.xgm.jgas.lang.documentation;
 ...
 */
final class AbstractDocumentationProvider_vJGAS extends AbstractDocumentationProvider {
  ...
  /**
   * Extracts the key, value, file and documentation comment of a Jass key/value entry and returns
   * a formatted representation of the information.
   */
  @Override
  public @Nullable String generateDoc(PsiElement element, @Nullable PsiElement originalElement) {
    if (element instanceof JGAS_Property) {
      final String key = ((JGAS_Property) element).getKey();
      final String value = ((JGAS_Property) element).getValue();
      final String file = SymbolPresentationUtil.getFilePathPresentation(element.getContainingFile());
      final String docComment = Util_JGAS.findDocumentationComment((JGAS_Property) element);
  ...
  /**
   * Provides the information in which file the Jass language key/value is defined.
   */
  @Override
  ...
  /**
   * Provides documentation when a Jass Language element is hovered with the mouse.
   */
  @Override
