...
public class AngelScriptBlockFor extends AngelScriptBlockBraceParent {
    public AngelScriptBlockFor(ASTNode myNode, Alignment myAlignment, Indent myIndent, AngelScriptBlockSettings settings) {
