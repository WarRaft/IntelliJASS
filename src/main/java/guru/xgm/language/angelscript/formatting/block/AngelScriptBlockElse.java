...
public class AngelScriptBlockElse extends AngelScriptBlockBraceParent {
    public AngelScriptBlockElse(ASTNode myNode, Alignment myAlignment, Indent myIndent, AngelScriptBlockSettings settings) {
